...
exam_module02_spec = ["implementation_id", "exam_module02", 
         "type_name",         "exam_module02", 
...
# 
# </rtc-template>
class exam_module02(OpenRTM_aist.DataFlowComponentBase):
...
def exam_module02Init(manager):
    profile = OpenRTM_aist.Properties(defaults_str=exam_module02_spec)
    manager.registerFactory(profile,
                            exam_module02,
                            OpenRTM_aist.Delete)

def MyModuleInit(manager):
    exam_module02Init(manager)
    ...
    # Create a component
    comp = manager.createComponent("exam_module02" + args)
